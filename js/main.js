...
const reviewsOverlay1 = openOverlay(' <span class="reviews__title reviews__titleOverlay"> Константин Спилберг</span> <br><p class="reviews__descOverlay">Мысли все о них и о них, о них и о них. Нельзя устоять, невозможно забыть... Никогда не думал, что булочки могут быть такими мягкими, котлетка такой сочной, а сыр таким расплавленным.</p>');
